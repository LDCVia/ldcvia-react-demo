var Person = React.createClass({
  ...
  editDocument: function(){
    this.setState({first_name: this.props.first_name, last_name: this.props.last_name, __unid: this.props.__unid})
    this.editmode = true;
  },
  ...
  handleDelete: function(){
    ...
    $.ajax({
      url: this.props.host + "/document/" + this.props.database + "/Person/" + this.props.__unid,
      dataType: 'json',
      type: 'DELETE',
      xhrFields: {
        withCredentials: true
...
var PeopleList = React.createClass({
  render: function() {
    var peopleNodes = this.props.data.map(function(person) {
      return (
        <Person first_name={person.first_name} last_name={person.last_name} __unid={person.__unid} key={person.__unid} host="https://eu.ldcvia.com/1.0" database="dev-londc-com-demos-200kpeople-nsf1444113120236">
          {person.first_name}
          {person.last_name}
          {person.__unid}
        </Person>
